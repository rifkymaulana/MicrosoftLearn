        ...
        case "3":
            ...
            do
            {
                try
                {
                    ...
                    ourAnimals[indexer, 2] = Convert.ToString(age);
                    go = false;
                }
                catch (Exception ex)
                {
            ...
            for (int i = 0; i < 6; i++)
            {
                Console.WriteLine("Successfully update age animal");
                Console.WriteLine(ourAnimals[indexer, i]);
            }
